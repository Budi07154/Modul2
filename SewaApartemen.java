...
public class SewaApartemen {
    ...
    static ArrayList <ApartemenEntity> tempTotalSewa = new ArrayList(); // data temporary hanya bersifat sementara
    ...
    public static void data_stok_apartemen(){
        ...
        for(int i=0;i<nama_apartemen.length;i++){
            stok.insert_stok(new ApartemenEntity(nama_apartemen[i],harga_apartemen[i]));
        }
    }
        ...
        if(ketemu == true){
            do{
                ...
                if (pil==1){
                    ...
                    pesan.add(new PemesananModel(id_pesan,nama_pel,Karyawan.getDataSales().get(index),tempTotalSewa));
    ...
    public static void transaksi(){
        ...
        if(ketemu == true){
            ...
            if(pil==1){
                ...
                for(int i=0;i<PembayaranEntity.apartemen.length;i++){
                    System.out.println(i+". "+PembayaranEntity.apartemen[i]);
                }
                System.out.print("Pilih = ");
                int pilih = input.nextInt();
